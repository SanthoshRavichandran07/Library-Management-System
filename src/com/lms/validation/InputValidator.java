...
public class InputValidator {
	...
	private static final String PUBLISHER_PATTERN = "^[A-Za-z0-9.,& ]{3,}$";
	...
	public boolean validNamePattern(String name) {
		return isValidString(name, NAME_PATTERN);

	}

	public boolean validTitlePattern(String title) {
		return isValidString(title, TITLE_PATTERN);

	}

	public boolean validPublisherPattern(String publisher) {
		return isValidString(publisher, PUBLISHER_PATTERN);

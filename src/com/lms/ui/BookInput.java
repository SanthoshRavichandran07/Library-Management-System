...
public class BookInput implements BookDAO {
	...
	public void searchBook() {
		...
		while (searchBook) {
			...
			case 6 -> {
				...
				if (!validate.validGenre((String) value)) {
					System.err.println(
							"Genre only contains set of characters and/or words and allowed symbol is ',' (comma)");
					break;
				}
	...
	public void viewBooks() {
		...
		while (viewBook) {
			...
			case 1 -> {
				List<Books> books = setInput.viewAllBooks();
				if (books.isEmpty()) {
					System.out.println("No books found.");
				} else {
					for (Books b : books) {
						System.out.println(b.getId() + " | " + b.getTitle() + " | " + b.getAuthor()+ " | " + b.getYear()+ " | " + b.getPublisherName()+ " | " + b.getGenre()+ " | " + b.getAvailability());
					}
				}
				System.out.println("----------");
			}
